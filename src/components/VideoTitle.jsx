...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='w-screen aspect-video pt-[10%] px-15 absolute bg-gradient-r from-black text-white/90 '>
      <h1 className='font-bold text-5xl py-2'>{title}</h1>
      <p className='text-lg w-5/12 py-4'>{overview}</p>
      <div>
        <button className='border-1 p-2 bg-white text-black text-l w-30 mr-2 rounded-lg cursor-pointer hover:bg-white/80 ' > ▶️Play</button>
